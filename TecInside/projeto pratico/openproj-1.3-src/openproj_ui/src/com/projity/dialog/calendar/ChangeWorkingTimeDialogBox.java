...
public class ChangeWorkingTimeDialogBox extends AbstractDialog{
    ...
    Intervals lastSelection=new Intervals();
	...
	protected void initControls() {
	    ...
	    defaultWorkingTime.addActionListener(new ActionListener(){
		    public void actionPerformed(ActionEvent e){
			    ...
			    service.makeDefaultDays(wc,sdCalendar.getSelectedIntervals(), sdCalendar.getSelectedWeekDays());
	    ...
	    nonWorking.addActionListener(new ActionListener(){
		    public void actionPerformed(ActionEvent e){
			    ...
			    try {
			    	// try on copy first
					service.setDaysNonWorking(copy,sdCalendar.getSelectedIntervals(), sdCalendar.getSelectedWeekDays());
				    service.setDaysNonWorking(wc,sdCalendar.getSelectedIntervals(), sdCalendar.getSelectedWeekDays());
	    ...
	    working.addActionListener(new ActionListener(){
		    public void actionPerformed(ActionEvent e){	    
			    ...
			    try {
                    service.setDaysWorkingHours(copy,sdCalendar.getSelectedIntervals(), sdCalendar.getSelectedWeekDays(),defaultWorkingHours);
                    service.setDaysWorkingHours(wc,sdCalendar.getSelectedIntervals(), sdCalendar.getSelectedWeekDays(),defaultWorkingHours);
    			    dirtyWorkingHours = false;
    			    updateWorkingHours();
                    updateView();
...
//				i.next();
            ...
            clearLastSelection();
            lastSelection.addAll(sdCalendar.getSelectedIntervals());
            for (int i =0; i <7; i++)
...
//		System.out.println("updating working hours");
        ...
        DayDescriptor day=service.getDay(form.getCalendar(),sdCalendar.getSelectedIntervals(),sdCalendar.getSelectedWeekDays());
        if (day==null){
